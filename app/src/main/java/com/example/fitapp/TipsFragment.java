...
public class TipsFragment extends Fragment {
    ...
    private Button tipsbutton1;
    private Button tipsbutton2;
    private Button tipsbutton3;
    public TipsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tipsbutton1 = view.findViewById(R.id.button);
        ...
        tipsbutton2 = view.findViewById(R.id.button2);
        ...
        tipsbutton3 = view.findViewById(R.id.button3);

        // Set a click listener on the ImageButton
        tipsbutton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Create a new instance of the fragment you want to open
